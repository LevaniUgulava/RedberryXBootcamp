        ...
        btn: !isCompleted ? {
            'text': 'Complete Course', 'icon': ` <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="white" stroke="#EEEDFC" stroke-width="0.5" />
                    </svg>` } : {
            'text': 'Retake Course', 'icon': `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
.enrolled {
    color: #736BEA;
    background-color: #736BEA1A;

}

.completed {
    color: #1DC31D;
    background-color: #1DC31D1A;
