...
type ProfileStatus = 'noAuth' | 'noComplete';
...
const ui = computed(() => {
    const isNoAuth = props.status === 'noAuth'
    return {
        isNoAuth,
        head: isNoAuth ? 'Authentication Required' : 'Complete Your Profile',
        desc: isNoAuth ? 'You need sign in to your profile before enrolling in this course.' : 'You need to fill in your profile details before enrolling in this course.',
        btn: isNoAuth ? 'Sign In' : 'Complete'
