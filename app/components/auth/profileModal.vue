                        ...
                        <div class="avatar-wrapper">
                            ...
                            <svg v-else width="56" height="56" viewBox="0 0 56 56" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#EEEDFC" />
                                <path
                                    d="M39.0833 42.25V39.0833C39.0833 37.4036 38.416 35.7927 37.2283 34.605C36.0406 33.4173 34.4297 32.75 32.75 32.75H23.25C21.5703 32.75 19.9593 33.4173 18.7716 34.605C17.5839 35.7927 16.9166 37.4036 16.9166 39.0833V42.25"
                                    stroke="#736BEA" stroke-width="2.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M28 26.4167C31.4978 26.4167 34.3333 23.5811 34.3333 20.0833C34.3333 16.5855 31.4978 13.75 28 13.75C24.5022 13.75 21.6666 16.5855 21.6666 20.0833C21.6666 23.5811 24.5022 26.4167 28 26.4167Z"
                                    stroke="#736BEA" stroke-width="2.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
